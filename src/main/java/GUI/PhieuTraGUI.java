...
public class PhieuTraGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtIdNguoiDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jDialogThemLayout.setVerticalGroup(
            ...
            .addGroup(jDialogThemLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cardsThem, javax.swing.GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jTableXemChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID sách", "Tên sách", "Số lượng trả", "Trạng thái"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jPanel7.add(btnXacNhanSua);

        jLabel14.setText("Ngày trả thật sự");
        ...
        jTablePhieuTra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Người đọc", "Ngày trả thật sự", "Tiền phạt"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jLabel2.setText("Danh sách phiếu trả");
        jPanel2.add(jLabel2);
    ...
    private void btnXemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemActionPerformed
        ...
        listCTPhieuTraVaSach.forEach((ctPhieuTraDTO, sachDTO) -> {
            xemChiTietModel.addRow(new Object[]{
                ...
                ctPhieuTraDTO.getTrangThaiSach()
            });
        });
        // Show
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // Get selected rows
        int[] selectedRows = jTablePhieuTra.getSelectedRows();
        ...
        for (int row : selectedRows) {
            Object id = jTablePhieuTra.getValueAt(row, 0);
        ...
        if (result == JOptionPane.YES_OPTION) {
            PhieuTraBUS phieuTraBUS = new PhieuTraBUS();
            CTPhieuTraBUS ctPhieuTraBUS = new CTPhieuTraBUS();
            arrayIdPhieuTra.forEach(idPhieuTra -> {
                ctPhieuTraBUS.deleteMany(idPhieuTra);
                phieuTraBUS.deleteOne(idPhieuTra);
            });
        }
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        CTPhieuTraBUS ctPhieuTraBUS = new CTPhieuTraBUS();
        phieuTraDTOCanThem.getListCTPhieuTra().forEach(ctPhieuTraBUS::insertOne);
    ...
    private void btnHienThiDanhSachTraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHienThiDanhSachTraActionPerformed
        // Check
        if (txtIdPhieuMuon.getText().isEmpty() || txtIdNguoiDoc.getText().isEmpty()) {
        ...
        if (nguoiDocDTOCanThem == null) {
            JOptionPane.showMessageDialog(jDialogThem, "Không có người đọc với id = " + idNguoiDoc);
            return;
        }
        // Check
        ...
        phieuTraDTOCanThem = new PhieuTraDTO(idPhieuTra, idNguoiDoc, LocalDate.now(), 0);
